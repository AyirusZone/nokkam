...
from nokkam.domain.models import Event, Project, Status, Tag, Task
from nokkam.domain.recurrence import RecurrenceRule
from nokkam.presentation.screens.help import HelpModal
from nokkam.presentation.screens.quick_add import QuickAddModal
from nokkam.presentation.screens.task_form import TaskFormModal, TaskFormResult
from nokkam.presentation.screens.task_list import TaskRow
from nokkam.presentation.screens.text_prompt import TextPromptModal
from nokkam.presentation.widgets.app_header import AppHeader
from nokkam.presentation.widgets.calendar_grid import CalendarGrid, DayCell
...
class EventRow(ListItem):
    ...
    editable/deletable from within nokkam, so no action handles it (the
